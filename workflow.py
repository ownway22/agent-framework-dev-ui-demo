...
def get_workflow() -> Workflow:
    ...
    email_analysis_agent = AgentExecutor(
        chat_client.create_agent(
            ...
            instructions=(
                ...
                "The company you work does projects for clients, so emails unrelated to that are uncertain or spam. "
                "Pleas to buy stuff, free money, and anything to do with crypto or bitcoin are spam. "
                "Also anything that does not mention a project should be Uncertain. "
                "Very short emails, like 'hello' or 'hi' should be treated as Uncertain. "
    ...
    workflow = (
        WorkflowBuilder(
            ...
            description="Workflow to triage and respond to emails.",
        )
